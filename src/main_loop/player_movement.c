    ...
    sfClock *clock, data_t *data)
{
    ...
    handle_backward_input(data->player, map, moveSpeed);
    handle_forward_input(data->player, map, moveSpeed);
    handle_left_input(data->player, map, moveSpeed);
    handle_right_input(data->player, map, moveSpeed);
